<%@ Page Title="" Language="C#" MasterPageFile="~/mercenari.master" AutoEventWireup="true" CodeFile="dettaglioeventi.aspx.cs" Inherits="_dettaglionews" %>

<%@ Register src="uc/menu.ascx" tagname="menu" tagprefix="uc1" %>

<%@ Register src="uc/Appuntamenti.ascx" tagname="Appuntamenti" tagprefix="uc2" %>

<%@ Register src="uc/evento.ascx" tagname="evento" tagprefix="uc3" %>
...
<asp:Content ID="divcontenuto" runat="server" ContentPlaceHolderID="content">
    ...
    <div class="news">
        ...
        <div class="grid_8">
            ...
            <uc3:evento ID="notizia1" runat="server" />
