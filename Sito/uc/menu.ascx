...
<ul class="navigation <% = SelectedMenu %>">
  <li id="notizie"><a href="/news.aspx" title="Notizie">NEWS</a></li>
	<li id="squadra"><a href="/squadra.aspx" title="La squadra">SQUADRA</a></li>
    <li id="concorso"><a href="/concorso.aspx" title="Concorso di disegno Il nostro Carnevale">CONCORSO</a></li>
