...
public partial class be_eventi : CheckLoginPage
{
    ...
    protected void RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "modifica")
        {
            try
            {
                Response.Redirect("/be/EventiEdit.aspx?IdNews=" + int.Parse(grdNews.DataKeys[int.Parse(e.CommandArgument.ToString())].Value.ToString()));
